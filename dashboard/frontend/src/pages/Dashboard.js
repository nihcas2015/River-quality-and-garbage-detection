...
function Dashboard({ riverData, federationStatus, latestReadings, alerts }) {
  ...
  const CLASS_COLORS_MAP = {
    Plastic: '#ef4444', Bottle: '#f97316', Metal: '#6366f1',
    Glass: '#3b82f6', Branch: '#22c55e', Textile: '#8b5cf6', Algae: '#06b6d4',
  };
  const FB_COLORS = ['#ef4444', '#f97316', '#eab308', '#22c55e', '#3b82f6', '#8b5cf6', '#06b6d4'];
